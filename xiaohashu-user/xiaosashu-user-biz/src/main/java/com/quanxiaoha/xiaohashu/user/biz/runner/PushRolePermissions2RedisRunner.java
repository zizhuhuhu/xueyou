...
import com.quanxiaoha.xiaohashu.user.biz.domain.mapper.RolePermissionRelMapper;
...
public class PushRolePermissions2RedisRunner implements ApplicationRunner {
    ...
    @Resource
    private RolePermissionRelMapper rolePermissionDOMapper;
    // 权限同步标记 Key
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(roleDOS)) {
                ...
                List<RolePermissionRel> rolePermissionDOS = rolePermissionDOMapper.selectByRoleIds(roleIds);
